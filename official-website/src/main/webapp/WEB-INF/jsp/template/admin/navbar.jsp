...
<div class="col-md-3 left_col">
        <div class="left_col scroll-view">
          ...
          <div class="navbar nav_title" style="border: 0;">
            <a href="<%=fullUrl %>/admin/home" class="site_title"><i class="fa fa-paw"></i> <span>后台管理平台</span></a>
          </div>
          ...
          <div class="profile">
            <div class="profile_pic">
              <img src="<%=fullUrl %>/resources/admin/images/img.jpg" alt="..." class="img-circle profile_img">
            </div>
