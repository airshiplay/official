...
<link id="bootstrap-style"
	href="<%=fullUrl%>/resources/admin/css/bootstrap.min.css"
	rel="stylesheet">
<link
	href="<%=fullUrl%>/resources/admin/css/bootstrap-responsive.min.css"
	rel="stylesheet">
<link id="base-style" href="<%=fullUrl%>/resources/admin/css/style.css"
	rel="stylesheet">
<link id="base-style-responsive"
	href="<%=fullUrl%>/resources/admin/css/style-responsive.css"
	rel="stylesheet">
<link
...
<link rel="shortcut icon"
	href="<%=fullUrl%>/resources/admin/img/favicon.ico">
<!-- end: Favicon -->
...
<body>
						...
						<li class="dropdown hidden-phone"><a
							...
							<ul class="dropdown-menu messages">
								...
								<li><a href="#"> <span class="avatar"><img
											src="<%=fullUrl%>/resources/admin/img/avatar.jpg"
	...
	<script src="<%=fullUrl%>/resources/admin/js/jquery-1.9.1.min.js"></script>
	<script
		src="<%=fullUrl%>/resources/admin/js/jquery-migrate-1.0.0.min.js"></script>

	<script
		src="<%=fullUrl%>/resources/admin/js/jquery-ui-1.10.0.custom.min.js"></script>

	<script src="<%=fullUrl%>/resources/admin/js/jquery.ui.touch-punch.js"></script>

	<script src="<%=fullUrl%>/resources/admin/js/modernizr.js"></script>

	<script src="<%=fullUrl%>/resources/admin/js/bootstrap.min.js"></script>

	<script src="<%=fullUrl%>/resources/admin/js/jquery.cookie.js"></script>

	<script src='<%=fullUrl%>/resources/admin/js/fullcalendar.min.js'></script>

	<script src='<%=fullUrl%>/resources/admin/js/jquery.dataTables.min.js'></script>

	<script src="<%=fullUrl%>/resources/admin/js/excanvas.js"></script>
	<script src="<%=fullUrl%>/resources/admin/js/jquery.flot.js"></script>
	<script src="<%=fullUrl%>/resources/admin/js/jquery.flot.pie.js"></script>
	<script src="<%=fullUrl%>/resources/admin/js/jquery.flot.stack.js"></script>
	<script src="<%=fullUrl%>/resources/admin/js/jquery.flot.resize.min.js"></script>

	<script src="<%=fullUrl%>/resources/admin/js/jquery.chosen.min.js"></script>

	<script src="<%=fullUrl%>/resources/admin/js/jquery.uniform.min.js"></script>

	<script src="<%=fullUrl%>/resources/admin/js/jquery.cleditor.min.js"></script>

	<script src="<%=fullUrl%>/resources/admin/js/jquery.noty.js"></script>

	<script src="<%=fullUrl%>/resources/admin/js/jquery.elfinder.min.js"></script>

	<script src="<%=fullUrl%>/resources/admin/js/jquery.raty.min.js"></script>

	<script src="<%=fullUrl%>/resources/admin/js/jquery.iphone.toggle.js"></script>

	<script
		src="<%=fullUrl%>/resources/admin/js/jquery.uploadify-3.1.min.js"></script>

	<script src="<%=fullUrl%>/resources/admin/js/jquery.gritter.min.js"></script>

	<script src="<%=fullUrl%>/resources/admin/js/jquery.imagesloaded.js"></script>

	<script src="<%=fullUrl%>/resources/admin/js/jquery.masonry.min.js"></script>

	<script src="<%=fullUrl%>/resources/admin/js/jquery.knob.modified.js"></script>

	<script src="<%=fullUrl%>/resources/admin/js/jquery.sparkline.min.js"></script>

	<script src="<%=fullUrl%>/resources/admin/js/counter.js"></script>

	<!-- <script src="<%=fullUrl%>/resources/admin/js/retina.js"></script> -->
