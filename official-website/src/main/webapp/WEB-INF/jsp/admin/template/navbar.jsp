...
<div class="col-md-3 left_col">
        <div class="left_col scroll-view">
          ...
          <div class="navbar nav_title" style="border: 0;">
            <a href="<%=contextPath%>/admin/home" class="site_title"><i class="fa fa-paw"></i> <span>后台管理平台</span></a>
          </div>
          ...
          <div class="profile">
            <div class="profile_pic">
              <img src="<%=contextPath%>/resources/admin/images/img.jpg" alt="..." class="img-circle profile_img">
            </div>
          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            ...
            <div class="menu_section">
              ...
              <ul class="nav side-menu">
                ...
                <li><a><i class="fa fa-table"></i>网站管理 <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
                   <li><a href="<%=contextPath%>/admin/config/banner">轮播配置</a>
                    </li>
                    <li><a href="<%=contextPath%>/admin/config/nav">导航配置</a>
                    </li>
                 ...
                 <li><a><i class="fa fa-desktop"></i>微信管理<span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
                    ...
                    <li><a href="<%=contextPath%>/admin/system/rolemanage">消息管理</a>
                    </li>
                    <li><a href="<%=contextPath%>/admin/system/rolemanage">文章管理</a>
                    </li>
                  </ul>
                </li>
                ...
                <li><a><i class="fa fa-edit"></i>系统配置 <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
                    <li><a href="<%=contextPath%>/admin/config/site">网站配置</a>
                    </li>
            ...
            <ul class="nav navbar-nav navbar-right">
              <li class="">
                <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                  <img src="<%=fullUrl %>/resources/admin/images/img.jpg" alt="">${currentUser.username}
                ...
                <ul class="dropdown-menu dropdown-usermenu animated fadeInDown pull-right">
                  ...
                  <li><a href="<%=fullUrl %>/admin/login"><i class="fa fa-sign-out pull-right"></i> Log Out</a>
                  </li>
                </ul>
              </li>
              ...
              <li role="presentation" class="dropdown">
                ...
                <ul id="menu1" class="dropdown-menu list-unstyled msg_list animated fadeInDown" role="menu">
                  <li>
                    <a>
                      <span class="image">
                                        <img src="<%=fullUrl %>/resources/admin/images/img.jpg" alt="Profile Image" />
                                    </span>
                      <span>
